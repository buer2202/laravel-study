...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wx8a799dcb7eb715c1'),         // AppID
    'secret'  => env('WECHAT_SECRET', '0d3bc4e1360de0875c5b245bfbfaff2d'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'wxtest'),          // Token
